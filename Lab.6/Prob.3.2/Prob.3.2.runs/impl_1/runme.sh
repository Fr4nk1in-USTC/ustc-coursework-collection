...
HD_PWD='D:/Code/Digital-Logic-Lab/Lab.6/Prob.3.2/Prob.3.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_32bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_32bit.tcl -notrace
