...
HD_PWD='D:/Code/Digital-Logic-Lab/Lab.6/Prob.3.2/Prob.3.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_32bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_32bit.tcl
