...
HD_PWD='D:/Code/Digital-Logic-Lab/Lab.6/Prob.3/Prob.3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_30bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_30bit.tcl -notrace
