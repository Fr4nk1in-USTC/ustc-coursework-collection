...
HD_PWD='D:/Code/Digital-Logic-Lab/Lab.6/Prob.3/Prob.3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_30bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_30bit.tcl
