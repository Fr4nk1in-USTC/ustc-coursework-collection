...
HD_PWD='D:/Code/Digital-Logic-Lab/Lab.8/Prob.4/Prob.4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log array_detect.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source array_detect.tcl -notrace
