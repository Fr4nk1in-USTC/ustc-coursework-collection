...
HD_PWD='D:/Code/Digital-Logic-Lab/Lab.8/Prob.4/Prob.4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log array_detect.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source array_detect.tcl
